...
<iframe width="560" height="315" src="https://www.youtube.com/embed/jk69_SFcL0Q" title="YouTube video player" frameborder="0" allow="accelerometer; autoplay; clipboard-write; encrypted-media; gyroscope; picture-in-picture; web-share" allowfullscreen></iframe>
...
In this example, all the rows match, so the result will look alike with any option. For more information on Merging Datasets click [here](https://www.alphacast.io/p/luciano/insights/2022-2-5-gKcGcd)
