...
There is an extensive library of formulas that can be used, including operators, logical and conditional formulas, grouping functions, and more. But let's begin with an easy example
...
Example 2: Add another **Calculate variable** step for this new exercise. Add formulas by typing the name and opening the parenthesis.
