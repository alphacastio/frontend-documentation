...
**02.** Choose the entity that you want to unstack and select the variable that you wish to use. Note that the other variables in the dataset will be discarded. 
