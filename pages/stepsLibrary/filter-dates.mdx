...
Another way to filter by date is clicking on the option "relative dates". It allows you to filter based on a certain time period relative to the current date.
Within the period option, you can select specific number of years, quarters, months or days.
